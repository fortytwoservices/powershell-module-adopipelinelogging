...
New-Variable -Scope Script -Name PATUnsecured -Value @{}
New-Variable -Scope Script -Name Organization -Value @{}
New-Variable -Scope Script -Name Project -Value @{}
New-Variable -Scope Script -Name Headers -Value $null
