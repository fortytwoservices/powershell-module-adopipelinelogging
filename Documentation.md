...
#### run
```
Get-PipelineLoggingPipelineRun -PipelineId <String> -RunId <String> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
#### text (Default)
```
Search-PipelineLogging -PipelineId <String> -Text <String> [-Latest <Int32>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

#### like
```
Search-PipelineLogging -PipelineId <String> -Like <String> [-Latest <Int32>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

#### match
```
Search-PipelineLogging -PipelineId <String> -Match <String> [-Latest <Int32>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
